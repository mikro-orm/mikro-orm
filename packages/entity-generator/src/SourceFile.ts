...
export class SourceFile {
  ...
  private propTypeBreakdowns = new WeakMap<EntityProperty, string[] | undefined>();

  private breakdownOfIType(prop: EntityProperty) {
    ...
    this.propTypeBreakdowns.set(prop, undefined);
    return;
  }
