...
> extends DatabaseDriver<Connection> {
  ...
  ): Promise<QueryBuilder<T, any, any, any, any, any, any>> {
  ...
  override mapResult<T extends object>(
    ...
    qb?: QueryBuilder<T, any, any, any, any, any, any>,
    map: Dictionary = {},
  ): EntityData<T> | null {
   ...
   */
  private mapTPTColumns<T extends object>(result: EntityData<T>, meta: EntityMetadata<T>, qb: QueryBuilder<T, any, any, any, any, any, any>): void {
   ...
   * @internal
   */
  protected findTPTChildAlias<T extends object>(qb: QueryBuilder<T, any, any, any, any, any, any>, childMeta: EntityMetadata): string | undefined {
  ...
  createQueryBuilder<T extends object>(
    entityName: EntityName<T> | QueryBuilder<T, any, any, any, any, any, any>,
    ctx?: Transaction,
    ...
    alias?: string,
    em?: SqlEntityManager,
  ): QueryBuilder<T, any, any, any, any, any, any> {
    ...
    const qb = new QueryBuilder<T, any, any, any, any, any, any>(entityName, this.metadata, this, ctx, alias, connectionType, em, loggerContext);
