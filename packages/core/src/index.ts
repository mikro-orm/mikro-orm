...
export type {
  ...
  EntityProps, ExpandProperty, ExpandScalar, FilterItemValue, ExpandQuery, Scalar, ExpandHint, FilterValue, MergeLoaded, MergeSelected, TypeConfig,
  ...
  type RequiredNullable, type DefineConfig, type Opt, type Hidden, type EntitySchemaWithMeta, type InferEntity,
} from './typings.js';
