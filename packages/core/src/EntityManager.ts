...
export class EntityManager<Driver extends IDatabaseDriver = IDatabaseDriver> {
   ...
   */
  protected async autoJoinRefsForFilters<T extends object>(meta: EntityMetadata<T>, options: FindOptions<T, any, any, any> | FindOneOptions<T, any, any, any>, parent?: { class: EntityClass<any>; propName: string }): Promise<void> {
