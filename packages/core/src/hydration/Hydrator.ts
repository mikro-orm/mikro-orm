...
export abstract class Hydrator implements IHydrator {
   ...
   * @inheritDoc
   */
  hydrate<T extends object>(entity: T, meta: EntityMetadata<T>, data: EntityData<T>, factory: EntityFactory, type: 'full' | 'reference', newEntity = false, convertCustomTypes = false, schema?: string, parentSchema?: string): void {
