...
describe('QueryBuilder', () => {
  ...
  test('select query', async () => {
    const qb = new QueryBuilder(Publisher2.name, MetadataStorage.getMetadata());
  ...
  test('select by m:1', async () => {
    const qb = new QueryBuilder(Author2.name, MetadataStorage.getMetadata());
  ...
  test('select by m:n', async () => {
    const qb = new QueryBuilder(Book2.name, MetadataStorage.getMetadata());
  ...
  test('select by m:n inversed', async () => {
    const qb = new QueryBuilder(BookTag2.name, MetadataStorage.getMetadata());
  ...
  test('select by m:n with populate', async () => {
    const qb = new QueryBuilder(Test2.name, MetadataStorage.getMetadata());
  ...
  test('insert query', async () => {
    const qb1 = new QueryBuilder(Publisher2.name, MetadataStorage.getMetadata());
    ...
    const qb2 = new QueryBuilder(Author2.name, MetadataStorage.getMetadata());
    ...
    const qb3 = new QueryBuilder(BookTag2.name, MetadataStorage.getMetadata());
