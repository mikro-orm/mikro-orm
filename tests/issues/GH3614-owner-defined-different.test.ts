import { Entity, IdentifiedReference, OneToOne, PrimaryKey, Property, Reference, wrap } from '@mikro-orm/core';
...
test('change a 1:1 relation with a new entity and delete the old one', async () => {
  const project = await createProject(); // inserting already fails thinking 'Peter' has project1 and project2 set
