import { Collection, Entity, EventSubscriber, FlushEventArgs, IdentifiedReference, ManyToOne, MikroORM, OneToMany, PrimaryKey, Property } from '@mikro-orm/core';
...
class ProjectUsersSubscriber implements EventSubscriber<ProjectUser> {
  ...
  public async afterFlush(args: FlushEventArgs): Promise<void> {
    ...
    for (const cs of changeSets) {
      const pk = cs.getPrimaryKey() as Record<string, unknown>;
