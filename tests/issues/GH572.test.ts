import { Ref, MikroORM, QueryOrder } from '@mikro-orm/sqlite';
...
describe('GH issue 572', () => {
  ...
  test(`GH issue 572`, async () => {
    ...
    expect(mock.mock.calls[0][0]).toMatch(
      'select `a0`.*, `b1`.`id` as `b1__id`, `b1`.`camel_case_field` as `b1__camel_case_field`, `b1`.`a_id` as `b1__a_id` from `a` as `a0` left join `b` as `b1` on `a0`.`id` = `b1`.`a_id` order by `b1`.`camel_case_field` asc',
    );
