...
test('GH6160 - order with filtered relation and limit (MariaDB)', async () => {
...
test('GH6160 - order without limit should work correctly (MariaDB)', async () => {
  orm.em.clear();
