...
test('simple cursor based pagination using `first` and `after` (id asc)', async () => {
  ...
  expect(cursor6.startCursor).toBe('');
  expect(cursor6.endCursor).toBe('');
...
test('simple cursor based pagination using `first` and `after` (id desc)', async () => {
  const mock = mockLogger(orm, ['query', 'query-params']);
...
test('simple cursor based pagination using `last` and `before` (id asc)', async () => {
  const mock = mockLogger(orm, ['query', 'query-params']);
...
test('simple cursor based pagination using `last` and `before` (id desc)', async () => {
  const mock = mockLogger(orm, ['query', 'query-params']);
