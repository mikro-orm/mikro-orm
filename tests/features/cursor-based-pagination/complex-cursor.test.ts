import { Cursor, FilterQuery, MikroORM, SimpleLogger, Ref, ref, serialize, Options } from '@mikro-orm/core';
...
describe.each(['sqlite', 'mysql', 'postgresql', 'mssql', 'mongo'] as const)(
  'simple cursor based pagination (%s)',
  type => {
    let orm: MikroORM;
    ...
    test('complex joined cursor based pagination using `last` and `before` (id asc)', async () => {
      ...
      expect(cursor1.startCursor).toBe(
        'W3siZW1haWwiOiJlbWFpbC05NiIsIm5hbWUiOiJVc2VyIDMifSwiVXNlciAzIiwzOCwiZW1haWwtNzYiXQ',
      );
      expect(cursor1.endCursor).toBe(
        'W3siZW1haWwiOiJlbWFpbC05NiIsIm5hbWUiOiJVc2VyIDMifSwiVXNlciAzIiw0OCwiZW1haWwtOTYiXQ',
      );
      ...
      expect(cursor2.startCursor).toBe(
        'W3siZW1haWwiOiJlbWFpbC05NiIsIm5hbWUiOiJVc2VyIDMifSwiVXNlciAzIiwyNiwiZW1haWwtNTEiXQ',
      );
      expect(cursor2.endCursor).toBe(
        'W3siZW1haWwiOiJlbWFpbC05NiIsIm5hbWUiOiJVc2VyIDMifSwiVXNlciAzIiwzNiwiZW1haWwtNzEiXQ',
      );
