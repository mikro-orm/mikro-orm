...
describe('virtual entities (sqlite)', () => {
  ...
  test('with callback', async () => {
    ...
    expect(queries).toEqual([
      ...
      `[query] select "b0".*, "a1"."id" as "a1__id", "a1"."created_at" as "a1__created_at", "a1"."updated_at" as "a1__updated_at", "a1"."name" as "a1__name", "a1"."email" as "a1__email", "a1"."age" as "a1__age", "a1"."terms_accepted" as "a1__terms_accepted", "a1"."optional" as "a1__optional", "a1"."identities" as "a1__identities", "a1"."born" as "a1__born", "a1"."born_time" as "a1__born_time", "a1"."favourite_book_uuid_pk" as "a1__favourite_book_uuid_pk", "a1"."favourite_author_id" as "a1__favourite_author_id", "a1"."identity" as "a1__identity", "f2"."uuid_pk" as "f2__uuid_pk" from (${sql}) as "b0" inner join "author2" as "a1" on "b0"."author_id" = "a1"."id" left join "book2" as "f2" on "a1"."favourite_book_uuid_pk" = "f2"."uuid_pk" and "f2"."author_id" is not null order by "b0"."author_name" asc, "b0"."title" asc`,
      `[query] select count(*) as "count" from (${sql}) as "b0" inner join "author2" as "a1" on "b0"."author_id" = "a1"."id" left join "book2" as "f2" on "a1"."favourite_book_uuid_pk" = "f2"."uuid_pk" and "f2"."author_id" is not null`,
    ]);
