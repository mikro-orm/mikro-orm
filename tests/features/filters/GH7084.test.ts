import { Embeddable, Embedded, Entity, Filter, MikroORM, PrimaryKey, Property } from '@mikro-orm/postgresql';
...
test('Lookup by id and filter - invalid results', async () => {
  const user = orm.em.create(User, {
    ...
    email: 'foo',
    validRange: {
      validBegin: '2026-01-01T00:00:00Z',
      validEnd: '2026-02-01T00:00:00Z',
    },
  });
  await orm.em.flush();
  orm.em.clear();
