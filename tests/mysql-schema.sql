...
create table `dummy2` (`id` int(10) unsigned not null auto_increment primary key) default character set utf8mb4 engine = InnoDB;

create table `car2` (`name` varchar(100) not null, `year` int(10) unsigned not null, `price` int(11) not null) default character set utf8mb4 engine = InnoDB;
...
create table `car_owner2` (`id` int(10) unsigned not null auto_increment primary key, `name` varchar(255) not null, `car_name` varchar(100) not null, `car_year` int(10) unsigned not null) default character set utf8mb4 engine = InnoDB;
...
create table `user2_cars` (`user2_first_name` varchar(100) not null, `user2_last_name` varchar(100) not null, `car2_name` varchar(100) not null, `car2_year` int(10) unsigned not null) default character set utf8mb4 engine = InnoDB;
...
create table `configuration2` (`property` varchar(255) not null, `test_id` int(10) unsigned not null, `value` varchar(255) not null) default character set utf8mb4 engine = InnoDB;
...
create table `publisher2_tests` (`id` int(10) unsigned not null auto_increment primary key, `publisher2_id` int(10) unsigned not null, `test2_id` int(10) unsigned not null) default character set utf8mb4 engine = InnoDB;
...
create table `test2_bars` (`test2_id` int(10) unsigned not null, `foo_bar2_id` int(10) unsigned not null) default character set utf8mb4 engine = InnoDB;
...
create table `author_to_friend` (`author2_1_id` int(10) unsigned not null, `author2_2_id` int(10) unsigned not null) default character set utf8mb4 engine = InnoDB;
...
create table `author2_following` (`author2_1_id` int(10) unsigned not null, `author2_2_id` int(10) unsigned not null) default character set utf8mb4 engine = InnoDB;
