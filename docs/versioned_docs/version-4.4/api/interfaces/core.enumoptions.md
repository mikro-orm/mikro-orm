...
Defined in: [packages/core/src/decorators/Enum.ts:19](https://github.com/mikro-orm/mikro-orm/blob/969d4229bd/packages/core/src/decorators/Enum.ts#L19)
...
• `Optional` **items**: *undefined* \| (*string* \| *number*)[] \| () => [*Dictionary*](../modules/core.md#dictionary)<*any*\>

Defined in: [packages/core/src/decorators/Enum.ts:18](https://github.com/mikro-orm/mikro-orm/blob/969d4229bd/packages/core/src/decorators/Enum.ts#L18)
