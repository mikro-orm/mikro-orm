...
[core](../modules/core.md).ReadOnlyException
...
\+ **new ReadOnlyException**(`previous`: Error): [*ReadOnlyException*](core.readonlyexception.md)
...
**Returns:** [*ReadOnlyException*](core.readonlyexception.md)
