...
[core](../modules/core.md).NonUniqueFieldNameException
...
\+ **new NonUniqueFieldNameException**(`previous`: Error): [*NonUniqueFieldNameException*](core.nonuniquefieldnameexception.md)
...
**Returns:** [*NonUniqueFieldNameException*](core.nonuniquefieldnameexception.md)
