...
> Using [`EntitySchema`](./define-entity.md#entityschema-low-level-api) is another way to define our entities, which is better suited than using `JavaScriptMetadataProvider`.
