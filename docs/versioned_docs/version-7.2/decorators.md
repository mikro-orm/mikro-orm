...
| `returning`        | `boolean`                                         | yes      | Whether this property should be part of `returning` clause. Works only in PostgreSQL, SQLite and MS SQL Server drivers; MySQL and MariaDB do not reload the value after insert.                                                                                                                                                                                 |
