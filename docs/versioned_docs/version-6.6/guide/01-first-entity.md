...
The last missing step is to initialize the [`MikroORM`](/api/6.6/core/class/MikroORM) to get access to the [`EntityManager`](/api/6.6/core/class/EntityManager) and other handy tools (like the [`SchemaGenerator`](/api/6.6/knex/class/SqlSchemaGenerator)).
