---
id: "mariadbdriver"
title: "Class: MariaDbDriver"
sidebar_label: "MariaDbDriver"
---

## Hierarchy

* AbstractSqlDriver&#60;[MariaDbConnection](mariadbconnection.md)>

  ↳ **MariaDbDriver**

## Implements

* IDatabaseDriver&#60;[MariaDbConnection](mariadbconnection.md)>

## Constructors

### constructor

\+ **new MariaDbDriver**(`config`: Configuration): [MariaDbDriver](mariadbdriver.md)

*Overrides void*

*Defined in [packages/mariadb/src/MariaDbDriver.ts:5](https://github.com/mikro-orm/mikro-orm/blob/18b580bb42/packages/mariadb/src/MariaDbDriver.ts#L5)*
...
**Returns:** [MariaDbDriver](mariadbdriver.md)
...
• `Protected` `Readonly` **connection**: [MariaDbConnection](mariadbconnection.md)
...
• `Protected` `Readonly` **replicas**: [MariaDbConnection](mariadbconnection.md)[]
...
▸ **connect**(): Promise&#60;[MariaDbConnection](mariadbconnection.md)>
...
**Returns:** Promise&#60;[MariaDbConnection](mariadbconnection.md)>
...
▸ `Protected`**createReplicas**(`cb`: (c: ConnectionOptions) => [MariaDbConnection](mariadbconnection.md)): [MariaDbConnection](mariadbconnection.md)[]
...
Name | Type |
------ | ------ |
`cb` | (c: ConnectionOptions) => [MariaDbConnection](mariadbconnection.md) |

**Returns:** [MariaDbConnection](mariadbconnection.md)[]
...
▸ **getConnection**(`type?`: &#34;read&#34; \| &#34;write&#34;): [MariaDbConnection](mariadbconnection.md)
...
*Defined in [packages/mariadb/src/MariaDbDriver.ts:11](https://github.com/mikro-orm/mikro-orm/blob/18b580bb42/packages/mariadb/src/MariaDbDriver.ts#L11)*
...
▸ **reconnect**(): Promise&#60;[MariaDbConnection](mariadbconnection.md)>
