...
| `returning`        | `boolean`                                         | yes      | Whether this property should be part of the `returning` clause of inserts, updates and upserts, reloading the database value into the entity. Works only in PostgreSQL, SQLite, MS SQL Server and Oracle drivers; MySQL and MariaDB do not reload the value.                                                                                                                                                                                 |
