...
| `defineEntity: boolean`                                                      | By default, generate entities using decorators. If `true`, generate the entities using `defineEntity` instead. This will emit class implementations by default, use `inferEntityType: true` to emit only types via `InferEntity` instead.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `inferEntityType: boolean`                                                   | If `defineEntity` is enabled, use this option to generate types (via `InferEntity`) instead of class declarations.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
