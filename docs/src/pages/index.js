...
const databases = [
  ...
  { name: 'SQLite', logo: 'img/databases/sqlite.svg', docsUrl: 'docs/usage-with-sqlite' },
  { name: 'MongoDB', logo: 'img/databases/mongodb.svg', docsUrl: 'docs/usage-with-mongo' },
  { name: 'MS SQL', logo: 'img/databases/mssql.svg', docsUrl: 'docs/usage-with-sql#ms-sql-server-limitations' },
  { name: 'libSQL', logo: 'img/databases/libsql.svg', docsUrl: 'docs/usage-with-sqlite#using-libsql--turso' },
  { name: 'CockroachDB', logo: 'img/databases/cockroachdb.svg', docsUrl: 'docs/usage-with-cockroachdb' },
  ...
  { name: 'PGlite', logo: 'img/databases/pglite.svg', docsUrl: 'docs/usage-with-sql', comingSoon: true },
];
